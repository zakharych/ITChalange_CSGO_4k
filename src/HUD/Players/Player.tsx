      ...
      <div className={`player ${player.state.health === 0 ? "dead" : ""} ${this.props.isObserved ? 'active' : ''}`}>
        <div className="player_data">
          ...
          <div className="player_stats">
            <div className="row">
              ...
              <div className="username_team"> {isLeft ? <span></span> : null} {player.name} {!isLeft ? <span></span> : null}</div>
        ...
        <div className={`freezetime_KAD ${!isFreezetime ? 'hide' : ''}`}>
          ...
          <div className="values">
            ...
            <div className="spent"> -${Math.abs(player.state.money - this.state.startRoundMoney)}
            </div>
            </div>
            </div>
